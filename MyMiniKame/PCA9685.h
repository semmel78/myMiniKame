...
#define PCA9685_SERVO_PULSE_MIN     1   // Minimal pulse length corresponding to 0° in milliseconds
#define PCA9685_SERVO_PULSE_MAX     2   // Maximal pulse length corresponding to 190° in milliseconds
...
public:
    ...
    // Servofunctions
    void setChannelAngel(int channel, int angel);
...
private:
    ...
    float _pwmFrequency;        //PWM Frequency
